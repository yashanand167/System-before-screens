...
export default function Chapter1() {
    return (
        <div className="h-auto md:h-[340vh] p-4 sm:p-10 md:p-20 pb-28 relative [perspective:2000px]">
            <div className="relative max-w-5xl mx-auto bg-[#FEFEFD] border border-neutral-200 rounded-2xl h-auto md:h-full w-full overflow-hidden p-6 sm:p-10 md:p-12 z-10">
                ...
                <section className="mt-12 md:mt-16 border-t border-neutral-100 pt-8 md:pt-12">
